...
def run(episodes, is_training=True, render=False):
    ...
    if is_training:
        ...
        with open('Laboratorios/Laboratorio7/Métodos/QTable/Valores_Optimistas/frozen_lake4x4.pkl', 'rb') as f:
            q = pickle.load(f)
        
    epsilon = 0  # Probabilidad inicial de tomar acciones aleatorias
    epsilon_min = 0  # Valor mínimo de epsilon
    epsilon_decay = (epsilon - epsilon_min) / episodes  # Tasa de disminución de epsilon
    ...
    plt.savefig('Laboratorios/Laboratorio7/Métodos/Gráficos/Valores_Optimistas/frozen_lake4x4_test.png')

    if is_training:
        with open("Laboratorios/Laboratorio7/Métodos/QTable/Valores_Optimistas/frozen_lake4x4.pkl", "wb") as f:
            pickle.dump(q, f)
